...
# This include file contains headers of Ansi C procs and definitions
# depending on an OS of Ansi C types in Nimrod syntax All symbols are
# prefixed with 'c_' to avoid ambiguities
